        ...
        <div>
            ...
            <div className="ContactPage">
                ...
                <div className="contact-sect">
                    <ContactItem  icon={phone} text1={'+2349071840139'}  title={'Phone'}/>
                    <ContactItem  icon={email} text1={'maamaavictor@gmail.com'} text2={'maamaavictor@yahoo.com'} title={'Email'}/>
                    <ContactItem  icon={location} text1={'25 Paramount St. PN4 Uyo'} text2={'Nigeria'} title={'Location'}/>
                </div>
        </div>
        </div>
    )
